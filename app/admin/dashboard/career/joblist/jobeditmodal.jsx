...
function JobModal({ openView, setOpenView,jobId, handleCloseView, GetAllJobsopening }) {
    console.log("jobId1111",jobId)
            ...
            <div className='w-full'>
                <Dialog open={openView} onOpenChange={setOpenView} >
                    <DialogContent className="h-100" >
                        <DialogHeader>
                            <div className="text-2xl font-bold">Update Job Opening</div>
                        </DialogHeader>
