...
function BlogMoadal({ openView, setOpenView, blogId, selectedApplication, handleCloseView, GetBlog }) {
    ...
    return (
        <div className='w-full'>
            <Dialog open={openView} onOpenChange={setOpenView}>
                ...
                <DialogContent className="w-6xl h-100" >
                    <DialogHeader>
                        <div className="text-2xl font-bold">Update Blogs</div>
                    </DialogHeader>
                    <div className='container overflow-y-auto overflow-x-hidden p-2 '>
